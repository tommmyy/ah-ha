...
async function addLicense(packageData) {
	const license = `/** @license @ahha v${packageData.version}
 *
...
`;
	await Promise.all(
		[
			'./index.js',
			'./esm/index.js',
			'./umd/ahha-hooks.development.js',
			'./umd/ahha-hooks.production.min.js',
		].map(async file => {
			try {
	...
	try {
		...
		await Promise.all(
			[
				...
				packageData.name === '@ah-ha/hooks' ? '../../README.md' : './README.md',
				// '../../CHANGELOG.md',
				'../../LICENSE',
